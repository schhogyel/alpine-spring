      ...
      <div className="">
        ...
        <div className="w-full max-w-screen-xl mx-auto px-6">
          <div className="lg:flex -mx-6">
            <div className="justify-center hidden lg:flex absolute z-90 top-16 bg-white w-full border-b -mb-16 lg:-mb-0 lg:static lg:bg-transparent lg:border-b-0 lg:pt-0 lg:w-1/4 lg:border-0 xl:w-1/4">
              <Sidebar />
            </div>
